...
const bingFetchImageUrls = require('./bing').fetchImageUrls;
const googleFetchImageUrls = require('./google').fetchImageUrls;
...
function fetchImageUrls(term, options) {
  if (options.bingApiKey) {
    return bingFetchImageUrls(options.bingApiKey, term, options.count);
  }
  if (options.googleCseId && options.googleApiKey) {
    return googleFetchImageUrls(options.googleCseId, options.googleApiKey, term, options.count);
  }
